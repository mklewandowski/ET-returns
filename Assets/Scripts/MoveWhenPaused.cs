...
public class MoveWhenPaused : MonoBehaviour
{
    enum MoveState {
        None,
        MoveUp,
    ...
    void Update()
    {
        ...
        {
            float newY = transform.localPosition.y + movingUpVelocity * Time.unscaledDeltaTime;
        ...
        {
            float newY = transform.localPosition.y + movingDownVelocity * Time.unscaledDeltaTime;
        ...
        {
            float newX = transform.localPosition.x + movingLeftVelocity * Time.unscaledDeltaTime;
        ...
        {
            float newX = transform.localPosition.x + movingRightVelocity * Time.unscaledDeltaTime;
